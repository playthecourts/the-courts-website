      ...
      {OPTIONS.map((opt) => {
        ...
        return (
          <button
            ...
            className={`flex min-h-[32px] items-center justify-center rounded-full border px-3 font-sport text-xs font-bold uppercase tracking-wide disabled:opacity-50 ${
